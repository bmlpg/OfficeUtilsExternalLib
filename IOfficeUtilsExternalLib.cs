...
{
    [OSInterface(Description = "Library which provides actions to generate Word and Excel files binary.", IconResourceName = "OfficeUtilsExternalLib.resources.officeutils_logo.png",  Name = "OfficeUtilsExternalLib")]
